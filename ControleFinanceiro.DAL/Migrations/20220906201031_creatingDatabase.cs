    ...
    public partial class creatingDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GainId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Description = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    CategoryId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Earnings", x => x.GainId);
                    table.ForeignKey(
                        name: "FK_Earnings_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "CategoryId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Earnings_Months_MonthId",
                        column: x => x.MonthId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Expenses_Cards_ExpenseId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "10771529-9638-4e31-ac2a-f24cb1290acb", "41c2f2fd-5052-45a3-bd83-d6ac72974e55", "Administrador do Sistema", "Administrador", "ADMINISTRADOR" },
                    { "f1081456-fa4f-4ff1-8c1c-b636a3b081f1", "3429372a-31f8-45ad-9eec-e8d862f2d3d8", "Usuário do Sistema", "Usuario", "USUARIO" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Earnings_CategoryId",
                table: "Earnings",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Earnings_MonthId",
                table: "Earnings",
                column: "MonthId");
